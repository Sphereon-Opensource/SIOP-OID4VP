export const AuthenticationRequestOptsSchema = {
  ...
  definitions: {
    AuthenticationRequestOpts: {
      ...
      required: ['redirectUri', 'requestBy', 'signatureType', 'registration'],
    ...
    RequestRegistrationOpts: {
      ...
      required: ['credentialFormatsSupported', 'registrationBy', 'subjectIdentifiersSupported'],
      additionalProperties: false,
    },
