import { IVerifyCredentialResult, ValidationStatusEnum, WDCErrors, WellKnownDidVerifier } from '@sphereon/wellknown-dids-client';

import { LinkedDomainValidationMode } from '../types';
