...
import * as AuthRequestService from './SIOPService';
...
export { AuthRequestService, RPAuthService, RPSession, DidAuthTypes, DidAuthHexUtils, DidAuthKeyUtils, ClientAgent };
