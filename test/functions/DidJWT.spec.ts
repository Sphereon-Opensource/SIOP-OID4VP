...
import {
  getIssuerDidFromJWT, getIssuerDidFromPayload,
  getMethodFromDid,
  getNetworkFromDid, isIssSelfIssued,
  parseJWT,
  toSIOPRegistrationDidMethod
} from '../../dist/main/functions/DidJWT';
...
describe('DidJWT ', () => {
  ...
  it('getIssuerDidFromJWT: should pass if throws NO_ISS_DID', async function() {
    let err = undefined;
    try {
      getIssuerDidFromJWT('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c');
    } catch (e) {
      err = e;
    }
  ...
  it('parseJWT: should pass if method returns with correct decoded ', async function() {
    const result = parseJWT('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c');
